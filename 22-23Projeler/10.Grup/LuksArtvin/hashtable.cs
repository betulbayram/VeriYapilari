...
public class HashTable
{
    ...
    public void Add(MyObject obj)
    {
        ...
        string valStr = obj.GetName() + "," + obj.GetSurname() + "," + obj.GetAge() + "," + obj.GetTel() + "," + obj.GetGorev(); // Değeri string olarak al
    ...
    private void SaveToCsv(string fileName)
    {
        ...
        // Başlık (header) satırını ekleyin
        sb.AppendLine("Name;Surname;Age;Telephone;Position");
