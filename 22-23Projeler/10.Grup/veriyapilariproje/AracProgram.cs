...
namespace Araclar
{
    class AracProgram
    {
        ...
        public static void ReadCsvFile(İkiYönlüListe liste)
        {
            ...
            var araclar = csvContext.Read<Vehicle>("C:/Users/isog1/source/repos/veriyapilariprojec/veriyapilariproje/araclarStogu.csv" +
                "", csvFileDescription);
        ...
        public static void WriteCsvFile(İkiYönlüListe liste)
        {
            ...
            var csvContext = new CsvContext();
            csvContext.Write(aracList, "C:/Users/isog1/source/repos/veriyapilariprojec/veriyapilariproje/araclarStogu.csv", csvFileDescription);
        ...
        public static List<string> ReturnCsvFile(İkiYönlüListe liste)
        {
            ...
            var csvContext = new CsvContext();
            var araclar = csvContext.Read<Vehicle>("C:/Users/isog1/source/repos/veriyapilariprojec/veriyapilariproje/araclarStogu.csv", csvFileDescription);
            foreach (var arac in araclar)
            {
